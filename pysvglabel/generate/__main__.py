...
if __name__ == "__main__":
    ...
    parser.add_argument("csv", type=str, help="Input CSV data file.")
    parser.add_argument(
        "output",
        type=str,
    ...
    page_tables = [table[start : start + template_page_count] for start in range(0, len(table), template_page_count)]
