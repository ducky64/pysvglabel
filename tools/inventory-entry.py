...
if __name__ == "__main__":
    ...
    parser.add_argument("csv", type=str, help="filename of the CSV.")
    parser.add_argument("id", type=str, nargs="?", help="row name of the ID field.", default="barcode")
    parser.add_argument("id_len", type=int, nargs="?", help="digits in the id field.", default=4)
    parser.add_argument(
        "format",
        type=str,
        nargs="?",
